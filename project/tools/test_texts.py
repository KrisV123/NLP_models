text = """
Peter ide do školy každý deň. V škole sa učí matematiku, slovenský
jazyk a informatiku.
Je veľmi šikovný a rád číta knihy?
Večer si píše domáce úlohy a pripravuje sa na testy."""

text_2 = """
Rákosiho brigáda, Petőfiho skupina, Sándor Nógrádi, József Fábry.
Tieto mená sa v našich mysliach nespájajú so Slovenským národným povstaním,
hoci povstania sa popri Slovákoch zúčastnili aj ľudia iných národností vrátane Maďarov.
Na ich rolu sa však v slovenskom a maďarskom povedomí takmer zabudlo.
Keďže základný výskum ešte neprebehol, nedá sa presne povedať, koľko Maďarov sa zapojilo do SNP.
Podľa historika Istvána Janeka, ktorý sa venuje československo-maďarským vzťahom, sa ich počet pohybuje od tristo
do päťsto a okrem Maďarov zo Slovenska boli medzi povstalcami aj zbehovia z maďarskej armády.
Na strane partizánov bojovali dve väčšie maďarské partizánske jednotky.
Petőfiho skupina
V tristočlennej skupine pomenovanej po Sándorovi Petőfim boli vo väčšine Maďari,
no aj táto skupina podobne ako celé SNP bola medzinárodná,
keďže v nej bojovali aj Ukrajinci, Rusi, Slováci a Česi.
Petőfiho skupinu pôvodne viedol ruský partizán, neskôr jej velenie prevzal József Fábry (od 1909 do 1971).
"""

text_3 = """
ÚVOD
Vrcholový šport je v dnešnej dobe na veľmi vysokej úrovni. To kladie značné nároky na
...
12
1 ŠPORTOVÁ PRÍPRAVA
Šimonek, in: Sýkora et al., (1995, s. 269) charakterizuje športovú prípravu ako: „veľký
...
1. 1 Etapy športovej prípravy
Športovú prípravu môžeme rozdeliť na jednotlivé etapy:
...
1. 2 Fázy športovej výkonnosti
Každý športovec má určité hranice, ktoré je schopný tréningom dosiahnuť. Hraničná
...
1. 3 Zložky športovej prípravy
Športový výkon je komplikovaný proces zahŕňajúci všestranný rozvoj osobnosti. Preto je
...
1. 3. 1 Kondičná príprava
Kondičná príprava sa zameriava na rozvoj pohybových schopností. Prostriedkami kondičnej
...
1. 3. 2 Technická príprava
Pod „technickou prípravou“ rozumieme efektívne osvojovanie si všeobecných a špeciálnych
...
National Guardsmen stand outside of the Edward Roybal Federal Building in downtown Los Angeles, California, on June 9, 2025.
National Guardsmen stand outside of the Edward Roybal Federal Building in downtown Los Angeles, California, on June 9, 2025.
...
This screengrab of a video posted to President Donald Trump’s Truth Social account on Tuesday, September 2, 2025, shows what Trump described as a Tren de Aragua boat carrying drugs from Venezuela, against which Trump ordered a strike.
This screengrab of a video posted to President Donald Trump’s Truth Social account on Tuesday, September 2, 2025, shows what Trump described as a Tren de Aragua boat carrying drugs from Venezuela, against which Trump ordered a strike.
...
Vice President JD Vance listens as President Donald Trump speaks at a dinner in the Rose Garden of the White House on September 5, 2025.
Vice President JD Vance listens as President Donald Trump speaks at a dinner in the Rose Garden of the White House on September 5, 2025.
Alex Brandon/AP
...
real_article_2 = """
Českí poľovníci potvrdili výskyt medveďa vo dvoch lokalitách v Česku. Jeden z nich sa pohyboval pri meste Hranice v Přerovskom okrese.
Trojica poľovníkov spozorovala druhého medveďa pri obci Senožaty v okrese Pelhřimov.
...
Podľa poľovníkov nejde o zvieratá, ktoré by sa do oblasti dostali prirodzenou migráciou. Majú preto podozrenie, že môžu pochádzať z niektorého z nepovolených chovov a že ich niekto zámerne vypúšťa do voľnej prírody.
Nie je vylúčené, že ich niekto dováža zo zahraničia.
Zvieratá môžu byť nebezpečné, preto poľovníci vyzývajú ľudí v týchto oblastiach, aby boli opatrní.
Medvede sú však chránené zvieratá a poľovníci ich nesmú strieľať.
"""

real_article_3 = """
Každý tretí lekár a zdravotná sestra v Európe uvádzajú, že trpia depresiou alebo úzkosťou, vyplýva zo štúdie zverejnenej európskou pobočkou Svetovej zdravotníckej organizácie (WHO).
Táto miera je päťkrát vyššia ako u bežnej populácie v Európe, uvádza sa v správe.
